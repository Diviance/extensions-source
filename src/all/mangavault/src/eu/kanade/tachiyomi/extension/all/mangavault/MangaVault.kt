...
open class MangaVault(private val suffix: String = "") :
    ...
    override val id by lazy {
        val key = "mangavault${if (suffix.isNotBlank()) " ($suffix)" else ""}/en/$versionId"
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        ...
        if (suffix.isEmpty()) {
            ListPreference(screen.context).apply {
                ...
                summary = "Number of additional sources to create. There will always be at least one MangaVault source."
    ...
    private val logTag by lazy { "mangavault${if (suffix.isNotBlank()) ".$suffix" else ""}" }
